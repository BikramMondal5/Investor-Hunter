              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Button 
                      variant="link" 
                      className="px-0 font-normal text-xs text-amber-500"
                      type="button"
                    >
                      Forgot password?
                    </Button>
            ...
            <form onSubmit={handleSignUp}>
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-400 text-center mt-4">
                  By signing up, you agree to our <a href="#" className="text-amber-500 hover:underline">Terms of Service</a> and <a href="#" className="text-amber-500 hover:underline">Privacy Policy</a>
                </p>
              </div>
            </form>
          </TabsContent>
